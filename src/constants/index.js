...
export const bucketBaseUrl =
	"https://bucket-glarriera-personal.s3.sa-east-1.amazonaws.com/";
...
export const resumeSections = [
	{
		key: "4",
		value: "Degree",
		description: "Formación Superior y Media",
		fieldsToShow: {
			subType: true,
			institution: true,
			title: true,
	...
	{
		key: "5",
		value: "FurtherTraining",
		description: "Formación Complementaria",
		fieldsToShow: {
			subType: true,
			title: true,
			institution: true,
	...
	{
		key: "7",
		value: "TeachingBackground",
		description: "Antecedentes en Docencia",
		fieldsToShow: {
			subType: true,
			title: true,
			institution: true,
	...
	{
		key: "8",
		value: "ManagementBackground",
		description: "Antecedentes en Gestión",
		fieldsToShow: {
			subType: true,
			title: true,
			institution: true,
	...
	},
	{
		...
		description: "Antecedentes en Investigación",
		fieldsToShow: {
			title: true,
			institution: true,
			startYear: true,
	...
	},
	{
		key: "10",
		value: "HRBackground",
		description: "Antecedentes en Formación y RRHH",
		fieldsToShow: {
			title: true,
			institution: true,
			startYear: true,
	...
	{
		key: "11",
		value: "EvaluationBackground",
		description: "Antecedentes en Evaluación",
		fieldsToShow: {
			title: true,
			institution: true,
			startYear: true,
	...
	},
	{
		key: "12",
		value: "STBackground",
		description: "Antecedentes en Ciencia y Tecnología",
		fieldsToShow: {
			title: true,
			institution: true,
			startYear: true,
	...
	{
		key: "13",
		value: "AcademicProduction",
		description: "Producciones Academicas",
		fieldsToShow: {
			title: true,
			institution: true,
			endYear: true,
	...
	},
	{
		key: "15",
		value: "Other",
		description: "Otros Antecedentes Profesionales",
		fieldsToShow: {
			title: true,
			institution: true,
			startYear: true,
...
export const degreeTypes = [
	...
	{
		value: "NonUniversitary-PostTitle",
		description: "No Universitario - PostTitulo",
	},
	{ value: "Grade", description: "Grado" },
	{
		value: "Postgraduate-Specialization",
		description: "PostGrado - Especialización",
	},
