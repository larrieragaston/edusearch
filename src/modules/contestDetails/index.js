				...
				<React.Fragment>
							...
							<TabPane tab="Programa" key="2">
								<Row style={{ padding: 20 }}>
									<Text>
										...
										para que escriban lo que quieran al docente por si creen que
										es necesario hacer alguna anotación previa a descargarse el
					...
					{data?.isClosed ? (
						<>
							...
							<Row justify="center">
								<Table
									dataSource={postulations}
									columns={
										data?.showResultsScore
											? columns
