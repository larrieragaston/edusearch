...
export default function PersonalInformation() {
  ...
  const [cities, setCities] = React.useState(
    userData?.address?.province
      ? provinces.filter((x) => x.name === userData.address.province).cities
      : []
  );
            ...
            <>
              <Row>
                ...
                <Col span={6}>
                  ...
                  <Row>
                    <Text type="secondary" className={styles.textsecondary}>
                      {data?.mobilePhone ?? noInformation}
                    </Text>
                  </Row>
                </Col>
                <Col span={6}>
              ...
              <Row>
                <Col span={6}>
                  ...
                  <Row>
                    <Text type="secondary" className={styles.textsecondary}>
                      {data?.address?.country ?? noInformation}
                    </Text>
                  </Row>
                  <Row>
                    <Text type="primary" className={styles.textprimary}>
                  ...
                  <Row>
                    <Text type="secondary" className={styles.textsecondary}>
                      {data?.address?.department ?? noInformation}
                    </Text>
                  </Row>
                </Col>
                <Col span={6}>
                  ...
                  <Row>
                    <Text type="secondary" className={styles.textsecondary}>
                      {data?.address?.postalCode ?? noInformation}
                    </Text>
                  </Row>
                </Col>
                <Col span={6}>
                  ...
                  <Row>
                    <Text type="secondary" className={styles.textsecondary}>
                      {data?.address?.floor ?? noInformation}
                    </Text>
                  </Row>
                </Col>
              </Row>
              ...
              <Form
                ...
                initialValues={{
                  ...
                  birthDate: data?.birthDate
                    ? moment(data.birthDate, "YYYY-MM-DDT00:00:00.000+00:00")
              ...
              >
                <Row style={{ justifyContent: "space-between" }}>
                  <Col span={6}>
                    ...
                    <Form.Item label="Lugar de nacimiento" name="birthPlace">
                      <Select
                        showSearch
                  ...
                  <Col span={6}>
                    ...
                    <Form.Item label="Teléfono celular" name="mobilePhone">
                      <Input />
                    </Form.Item>
                  </Col>
                  <Col span={6}>
